...
class AnimeQuestion {
  ...
  List<Question> _questions = [
    ...
    Question(
        ...
        3), //freedom
    Question('Who created the animated movie “Spirited Away” (2001)?', 3),
    Question(
    ...
    Question(
        ...
        2),
    Question('What is the name of the corgi in Cowboy Bebop?', 2),
    Question(
    ...
    Question(
        ...
        2),
    Question('Which of these anime have over 7,500 episodes?', 2),
    Question('What year did “Attack on Titan” Season 2 begin airing?', 2),
  ];
  void nextQuestion() {
